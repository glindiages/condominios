(function () {
    ...
    LocacaoListController.$inject = ['LocacaoService', 'DialogBuilder']

    function LocacaoListController(LocacaoService, DialogBuilder) {
        var vm = this;
        vm.data = {};
        vm.filtro = '';
        vm.page = {
        ...
        function load() {
            LocacaoService.findAll(vm.filtro, vm.page)
                .then(function (dados) {
                    vm.data = dados
                });
        }
