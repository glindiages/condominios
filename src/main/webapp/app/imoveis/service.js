(function(){
    ...
    ImovelService.$inject = ['$http'];

    function ImovelService($http) {

        function findAllOver() {
            return $http.get('http://localhost:8080/api/imoveis/all?order=descricao')
        ...
        function findAll(filtro, page) {
            return $http.get('http://localhost:8080/api/imoveis?page=' + page.number 
        ...
        function findById(id) {
            return $http.get('http://localhost:8080/api/imoveis/' + id)
              .then(function (response) {
                  return response.data;
              });
        }
        ...
        function insert(registro) {
            return $http.post('http://localhost:8080/api/imoveis', registro)
              .then(function (response) {
                  return response.data;
              });
        }
        ...
        function update(registro) {
            return $http.put('http://localhost:8080/api/imoveis/' + registro.id, registro)
              .then(function (response) {
                  return response.data;
              });
        }
        ...
        function remove(id) {
            return $http.delete('http://localhost:8080/api/imoveis/' + id)
              .then(function (response) {
                  return response.data;
              });
        }
